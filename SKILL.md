...
- `references/claims-validation.md` — sourcing map for the router's load-bearing claims (claim → authoritative standard/textbook/paper → source-backed or qualified verdict; 53 claims; not an audit certificate).
