...
- **Mesh-objectivity proven** — characteristic-length / G_c regularization active whenever softening runs; **mesh-sensitivity study** showing ultimate load & energy converge; element size below the snap-back floor L_c < ~2EG_c/σ² (§3). A CDM result on a single mesh is unverified.
